...
`programs-split/` 초안은 이 저장소에 없습니다. 없는 주를 추정해 채우지 않습니다. 공개 시드는 생성기 주(Takano 12 / Catalyst 12 / Torokhtiy 13 / LBEB 12, 빈 날 없음 → 진행 가능). LBEB W7–12는 Cycle 2 W3–Cycle 3 W4 (`public-lbeb-12w-olympic`).
